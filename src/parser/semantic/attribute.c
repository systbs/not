                            ...
                            while (node2 != NULL)
                            {
                                ...
                                for (a3 = block2->list->begin;a3 != block2->list->end;a3 = a3->next)
                                {
                                    ...
                                    if (item2->kind == NODE_KIND_HERITAGE)
                                    {
                                        ...
                                        {
                                            node_t *value_update2 = heritage2->value_update;

                                            if (value_update2->kind == NODE_KIND_CLASS)
                                            {
                                                node_class_t *class2 = (node_class_t *)value_update2->value;
                                                ...
                                                for (a4 = block3->list->begin;a4 != block3->list->end;a4 = a4->next)
                                                {
                                                    ...
                                                    {
                                                        node_fun_t *fun2 = (node_fun_t *)item3->value;
                                                        if (semantic_idcmp(fun2->key, basic->right) == 1)
                                                        {
                                                            if ((value_update2->flag & NODE_FLAG_INSTANCE) != NODE_FLAG_INSTANCE)
                                                            {
                                                                if ((fun2->flag & SYNTAX_MODIFIER_STATIC) != SYNTAX_MODIFIER_STATIC)
                                        ...
                                        else
                                        {
                                            ...
                                            int32_t r2 = semantic_resolve(program, heritage2->type->parent, heritage2->type, response2, SEMANTIC_FLAG_NONE);
                                            if (r2 == -1)
                                            {
                                                return -1;
                                            }
                                            else
                                            {
                                                ...
                                                for (a4 = response2->begin;a4 != response2->end;a4 = a4->next)
                                                {
                                                    ...
                                                    if (item3->kind == NODE_KIND_CLASS)
                                                    {
                                                        if ((item3->kind & NODE_FLAG_INSTANCE) != NODE_FLAG_INSTANCE)
                                                        {
                                                            semantic_error(program, heritage2->type, "Instance object, in confronting with (%s-%lld:%lld)",
                                                                item3->position.path, item3->position.line, item3->position.column);
                                                            return -1;
                                                        }
                                                                            ...
                                                                            for (a6 = block3->list->begin;a6 != block3->list->end;a6 = a6->next)
                                                                            {
                                                                                ...
                                                                                if (item5->kind == NODE_KIND_CLASS)
                                                                                {
                                                                                    ...
                                                                                    if (semantic_idcmp(class3->key, basic->right) == 1)
                                                                                    {
                                                                                        ...
                                                                                        ilist_t *r4 = list_rpush(response, item5);
                                                                                        if (r4 == NULL)
                                                                                        {
                                                                                            fprintf(stderr, "Internal:%s-%u\n\tUnable to allocate memory\n", __FILE__, __LINE__);
                                                                                            return -1;
                                                                                ...
                                                                                if (item5->kind == NODE_KIND_FUN)
                                                                                {
                                                                                    node_fun_t *fun2 = (node_fun_t *)item5->value;
                                                                                    if (semantic_idcmp(fun2->key, basic->right) == 1)
                                                                                    {
                                                                                        if ((clone1->flag & NODE_FLAG_INSTANCE) != NODE_FLAG_INSTANCE)
                                                                                        {
                                                    ...
                                                    {
                                                        semantic_error(program, heritage2->type, "Wrong type, in confronting with (%s-%lld:%lld)",
                                                            item3->position.path, item3->position.line, item3->position.column);
                                                        return -1;
                                                    }
                                                }
                                        ...
                                        for (a4 = block2->list->begin;a4 != block2->list->end;a4 = a4->next)
                                        {
                                            ...
                                            if (item3->kind == NODE_KIND_HERITAGE)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    int32_t r3 = semantic_resolve(program, heritage2->type->parent, heritage2->type, response3, SEMANTIC_FLAG_NONE);
                                                    if (r3 == -1)
                                                    {
                                                        return -1;
                                                    }
